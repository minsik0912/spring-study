...
@ToString
@NoArgsConstructor
public class ConsumerMessage implements Comparable<ConsumerMessage>, Serializable {
    ...
    public ConsumerMessage(ConsumerMessage message) {
    ...
    @Override
    public int compareTo(ConsumerMessage syncReq) {
